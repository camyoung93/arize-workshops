#!/usr/bin/env python3
"""
StreamFlix Feature Store Monitoring — synthetic data ingestion for Arize.
...
Usage:
  ...
  pip install arize pandas numpy   # requires Python 3.10+ for arize>=8
  python streamflix_feature_store_ingest.py
"""
...
from arize.ml.types import Schema, Environments, ModelTypes

# -----------------------------------------------------------------------------
# Config
# -----------------------------------------------------------------------------
MODEL_NAME = "streamflix_feature_store_monitor"
ROWS_PER_DAY = 10_000
NUM_DAYS = 30
RNG_SEED = 42
